...
class UntitledTestCase(unittest.TestCase):
    ...
    def test_untitled_test_case(self):
        ...
        driver.find_element_by_link_text("Linear algebra & Calculus").click()
        ...
        driver.find_element_by_id("id_status_1643").click()
        driver.find_element_by_id("id_submitbutton").click()

        
        #driver.get("http://lms.rgukt.ac.in/mod/attendance/attendance.php?sessid=11997&sesskey=49rT1ENXrl")
