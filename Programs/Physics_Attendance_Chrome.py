...
class UntitledTestCase(unittest.TestCase):
    ...
    def test_untitled_test_case(self):
        ...
        driver.find_element_by_link_text("Engineering Physics").click()
        driver.execute_script("arguments[0].scrollIntoViewIfNeeded(true);", driver.find_element_by_link_text("ENGINEERING PHYSICS CLASS ATTENDANCE"))
        driver.find_element_by_link_text("ENGINEERING PHYSICS CLASS ATTENDANCE").click()
        ...
        driver.find_element_by_id("id_status_1687").click()
        driver.find_element_by_id("id_submitbutton").click()

        
        
        #driver.get("http://lms.rgukt.ac.in/mod/attendance/view.php?id=7781")
