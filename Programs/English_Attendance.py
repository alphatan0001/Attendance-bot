...
class UntitledTestCase(unittest.TestCase):
    ...
    def test_untitled_test_case(self):
        ...
        driver.find_element_by_link_text("E_1_English_CHEM_CE_EEE_ME_MME").click()
        ...
        driver.find_element_by_id("id_status_2135").click()
        driver.find_element_by_id("id_submitbutton").click()
        


        #driver.get("http://lms.rgukt.ac.in/mod/attendance/attendance.php?sessid=16374&sesskey=p5nygcteYn")
